...
```
This graph shows that people who own a gunn are more likely to favor capital punishment
...
The fisherexact test has a p-value of .01651 hence we reject the null hypothesis, as with the chi square test, and furthermore the odds ratio says that gunowners are 2.3 times more likely to favor captia punishment that those who dont own a gun
...
### Quesion 1: is gun ownership independent of opinon on capital punishment. 

The summary results and the inferential results shows that they are not independent.
